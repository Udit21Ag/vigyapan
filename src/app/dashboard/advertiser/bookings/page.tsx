        ...
        <div className="min-h-screen flex bg-gradient-to-b from-gray-900 to-gray-800">
            ...
            <main className="flex-1 p-8">
                <div className="max-w-6xl mx-auto">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-4xl font-bold text-gray-100 mb-2">Your Bookings</h1>
                    ...
                    {loading ? (
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-xl font-semibold text-gray-200 mb-2">Loading Your Bookings</h3>
                            <p className="text-gray-400">Please wait while we fetch your booking history...</p>
                        </div>
                    ) : bookings.length === 0 ? (
                        <div className="text-center py-16">
                            <div className="text-8xl mb-6">📅</div>
                            <h3 className="text-2xl font-bold text-gray-200 mb-4">No Bookings Yet</h3>
                            ...
                            <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 max-w-lg mx-auto mb-6">
                                <h4 className="font-semibold text-blue-300 mb-2">🚀 Ready to Get Started?</h4>
                        ...
                        <>
                                ...
                                <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-2xl font-bold text-gray-100">{bookings.length}</p>
                                        </div>
                            ...
                            <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6 mb-8">
                                <h3 className="text-lg font-semibold text-gray-100 mb-4">Filters & Search</h3>
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <select
                                        ...
                                        className="border border-gray-600 rounded-lg px-4 py-3 text-gray-100 bg-gray-700 focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-3 bg-gray-700 text-gray-300 rounded-lg font-medium hover:bg-gray-600 transition border border-gray-600"
                                    >
                                        Clear Filters
                                    </button>
                                </div>
                            ...
                            <div className="space-y-4">
                                {filteredBookings.map((booking) => (
                                    <div
                                        ...
                                        className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 hover:shadow-md transition-all"
                                    >
                                        <div className="p-6">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-400">
                                                        <div>
                                                            ...
                                                            <p className="text-gray-200 mt-1 font-mono text-xs">
                                                        ...
                                                        <div>
                                                            ...
                                                            <Link
                                                                ...
                                                                className="text-green-400 hover:text-green-300 font-medium mt-1 block"
                                                            >
                                                                View Details →
                                                            </Link>
                                                        </div>
