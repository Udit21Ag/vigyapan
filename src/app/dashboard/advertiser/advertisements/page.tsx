        ...
        <div className="min-h-screen flex bg-gradient-to-b from-gray-900 to-gray-800">
            ...
            <main className="flex-1 p-8">
                <div className="max-w-6xl mx-auto">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-4xl font-bold text-gray-100 mb-2">Your Advertisements</h1>
                    ...
                    {loading ? (
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-xl font-semibold text-gray-200 mb-2">Loading Advertisements</h3>
                            <p className="text-gray-400">Please wait while we fetch your advertisements...</p>
                        </div>
                    ) : ads.length === 0 ? (
                        <div className="text-center py-16">
                            <div className="text-8xl mb-6">📢</div>
                            <h3 className="text-2xl font-bold text-gray-200 mb-4">No Advertisements Yet</h3>
                            ...
                            <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 max-w-lg mx-auto">
                                <h4 className="font-semibold text-blue-300 mb-2">💡 Get Started</h4>
                        ...
                        <>
                            ...
                            <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6 mb-8">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-100 mb-1">Active Advertisements</h3>
                                        <p className="text-gray-300">Confirmed billboard bookings</p>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="text-center">
                                            <div className="text-3xl font-bold text-green-500">{ads.length}</div>
